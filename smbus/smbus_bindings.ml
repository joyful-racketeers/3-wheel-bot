...
external i2c_smbus_read_byte_data
  :  fd
  -> u8
  -> u8
  = "ml_i2c_smbus_read_byte_data"
...
external i2c_smbus_read_word_data
  :  fd
  -> u8
  -> u16
  = "ml_i2c_smbus_read_word_data"
...
external i2c_smbus_process_call
  :  fd
  -> u8
  -> u16
  -> u8
  = "ml_i2c_smbus_process_call"
